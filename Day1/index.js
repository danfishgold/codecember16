...
var _elm_community$random_extra$Random_Color$blue = A2(
	_elm_lang$core$Random$map,
	function (blue) {
		return A3(_elm_lang$core$Color$rgb, 0, 0, blue);
	},
	A2(_elm_lang$core$Random$int, 0, 255));
var _elm_community$random_extra$Random_Color$green = A2(
	_elm_lang$core$Random$map,
	function (green) {
		return A3(_elm_lang$core$Color$rgb, 0, green, 0);
	},
	A2(_elm_lang$core$Random$int, 0, 255));
var _elm_community$random_extra$Random_Color$red = A2(
	_elm_lang$core$Random$map,
	function (red) {
		return A3(_elm_lang$core$Color$rgb, red, 0, 0);
	},
	A2(_elm_lang$core$Random$int, 0, 255));
var _elm_community$random_extra$Random_Color$greyscale = A2(
	_elm_lang$core$Random$map,
	_elm_lang$core$Color$greyscale,
	A2(_elm_lang$core$Random$float, 0, 1));
var _elm_community$random_extra$Random_Color$grayscale = _elm_community$random_extra$Random_Color$greyscale;
var _elm_community$random_extra$Random_Color$hsla = A5(
	_elm_lang$core$Random$map4,
	_elm_lang$core$Color$hsla,
	A2(
		_elm_lang$core$Random$map,
		_elm_lang$core$Basics$degrees,
		A2(_elm_lang$core$Random$float, 0, 360)),
	A2(_elm_lang$core$Random$float, 0, 1),
	A2(_elm_lang$core$Random$float, 0, 1),
	A2(_elm_lang$core$Random$float, 0, 1));
var _elm_community$random_extra$Random_Color$hsl = A4(
	...
	A2(_elm_lang$core$Random$float, 0, 1),
	A2(_elm_lang$core$Random$float, 0, 1));
var _elm_community$random_extra$Random_Color$rgba = A5(
	_elm_lang$core$Random$map4,
	...
	A2(_elm_lang$core$Random$int, 0, 255),
	A2(_elm_lang$core$Random$float, 0, 1));
var _elm_community$random_extra$Random_Color$rgb = A4(
	_elm_lang$core$Random$map3,
...
var _user$project$Argyle$translation = F3(
	function (_p0, i, j) {
		var _p1 = _p0;
		var _p2 = _p1.shift;
		var wd = _p1.width * _p1.window.width;
		var dx = ((0 - wd) * _elm_lang$core$Tuple$first(_p2)) + ((_elm_lang$core$Basics$toFloat(j) - (_elm_lang$core$Basics$toFloat(
			A2(_elm_lang$core$Basics_ops['%'], i, 2)) / 2)) * wd);
		var dy = ((0 - wd) * _elm_lang$core$Tuple$second(_p2)) + (((_elm_lang$core$Basics$toFloat(i - 1) * wd) * _p1.aspectRatio) / 2);
...
var _user$project$Argyle$lineGroup = F3(
	function (_p3, i, j) {
		var _p4 = _p3;
		var _p7 = _p4.window;
		var _p6 = _p4.width;
		var lineProps = {
			...
			_0: _elm_lang$svg$Svg_Attributes$stroke(
				_eskimoblood$elm_color_extra$Color_Convert$colorToCssRgb(_p4.lineColor)),
			_1: {
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$strokeWidth('1.5'),
				_1: {
					ctor: '::',
					_0: A3(_user$project$Argyle$translation, _p4, i, j),
					_1: {
						ctor: '::',
		...
		var _p5 = {ctor: '_Tuple2', _0: (_p7.width * _p6) / 4, _1: ((_p7.width * _p6) * _p4.aspectRatio) / 4};
		var wd = _p5._0;
		var ht = _p5._1;
		var pts1 = {
			ctor: '::',
			_0: _elm_lang$svg$Svg_Attributes$x1(
				_elm_lang$core$Basics$toString(wd)),
			_1: {
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$y1(
					_elm_lang$core$Basics$toString(ht)),
				_1: {
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$x2(
						_elm_lang$core$Basics$toString(3 * wd)),
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$y2(
							_elm_lang$core$Basics$toString(3 * ht)),
						_1: {ctor: '[]'}
					}
				}
			}
		...
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					A2(_elm_lang$core$Basics_ops['++'], lineProps, pts1),
					{ctor: '[]'}),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$svg$Svg$line,
						A2(_elm_lang$core$Basics_ops['++'], lineProps, pts2),
						{ctor: '[]'}),
					_1: {ctor: '[]'}
				}
			});
	});
var _user$project$Argyle$parallelogramColor = F3(
	function (model, i, j) {
		var _p8 = {
			ctor: '_Tuple2',
			_0: A2(_elm_lang$core$Basics_ops['%'], i, 4),
			_1: A2(_elm_lang$core$Basics_ops['%'], j, 2)
		};
		_v2_4:
		do {
			if (_p8.ctor === '_Tuple2') {
...
var _user$project$Argyle$parallelogram = F3(
	function (_p9, i, j) {
		var _p10 = _p9;
		var _p14 = _p10;
		var _p13 = _p10.aspectRatio;
		var wd = _p10.width * _p10.window.width;
		var pts = A2(
			...
			A2(
				...
				{
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: wd / 2, _1: 0},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: wd, _1: (wd / 2) * _p13},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: wd / 2, _1: wd * _p13},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 0, _1: (wd / 2) * _p13},
								_1: {ctor: '[]'}
							}
						}
					}
				}));
		var color = _eskimoblood$elm_color_extra$Color_Convert$colorToCssRgb(
			A3(_user$project$Argyle$parallelogramColor, _p14, i, j));
		return A2(
			_elm_lang$svg$Svg$polygon,
			{
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: A3(_user$project$Argyle$translation, _p14, i, j),
						_1: {ctor: '[]'}
					}
				}
			},
...
var _user$project$Argyle$view = function (_p15) {
	var _p16 = _p15;
	var _p19 = _p16.window;
	var _p18 = _p16.width;
	var _p17 = {
		ctor: '_Tuple2',
		_0: _elm_lang$core$Basics$ceiling(1 / _p18) + 2,
		_1: _elm_lang$core$Basics$ceiling(1 / ((_p18 * _p16.aspectRatio) / 2)) + 2
	};
	var n = _p17._0;
	var m = _p17._1;
	var row = F2(
	...
	var repeat = function (shape) {
		return A2(
			...
			A2(
				...
				row(shape),
				A2(_elm_lang$core$List$range, 0, m)));
	};
	return A2(
		_elm_lang$svg$Svg$svg,
		{
			...
			_0: _elm_lang$svg$Svg_Attributes$width(
				_elm_lang$core$Basics$toString(_p19.width)),
			_1: {
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$height(
					_elm_lang$core$Basics$toString(_p19.height)),
				_1: {ctor: '[]'}
			}
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: repeat(_user$project$Argyle$parallelogram),
					_1: {
						ctor: '::',
						_0: repeat(_user$project$Argyle$lineGroup),
						_1: {ctor: '[]'}
					}
				}),
			_1: {ctor: '[]'}
...
var _user$project$Argyle$randomModel = function (window) {
	...
	var colors = A5(
		...
		_elm_community$random_extra$Random_Color$hsl,
		_elm_community$random_extra$Random_Color$hsl,
		_elm_community$random_extra$Random_Color$hsl,
		_elm_community$random_extra$Random_Color$hsl);
	var shift = A3(
...
var _user$project$Argyle$Flags = F3(
	function (a, b, c) {
		return {width: a, height: b, randomize: c};
	});
var _user$project$Argyle$WindowSize = F2(
	function (a, b) {
...
var _user$project$Argyle$init = function (_p22) {
	...
	return {
		ctor: '_Tuple2',
		_0: {
			color1: _elm_lang$core$Color$blue,
			color2: _elm_lang$core$Color$green,
			color3: _elm_lang$core$Color$red,
			lineColor: _elm_lang$core$Color$gray,
...
var _user$project$Argyle$subscriptions = function (model) {
	return _elm_lang$keyboard$Keyboard$ups(_user$project$Argyle$KeyPressed);
};
var _user$project$Argyle$main = _elm_lang$html$Html$programWithFlags(
	{init: _user$project$Argyle$init, view: _user$project$Argyle$view, update: _user$project$Argyle$update, subscriptions: _user$project$Argyle$subscriptions})(
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (height) {
			return A2(
					...
					return A2(
						...
						function (width) {
							return _elm_lang$core$Json_Decode$succeed(
								{height: height, randomize: randomize, width: width});
						},
						A2(_elm_lang$core$Json_Decode$field, 'width', _elm_lang$core$Json_Decode$float));
				},
				A2(_elm_lang$core$Json_Decode$field, 'randomize', _elm_lang$core$Json_Decode$bool));
		},
		A2(_elm_lang$core$Json_Decode$field, 'height', _elm_lang$core$Json_Decode$float)));

var Elm = {};
Elm['Argyle'] = Elm['Argyle'] || {};
if (typeof _user$project$Argyle$main !== 'undefined') {
    _user$project$Argyle$main(Elm['Argyle'], 'Argyle', undefined);
}
