...
var _user$project$Day2_Ryb$toRgba = function (_p0) {
	var _p1 = _p0;
	var b = _elm_lang$core$Basics$toFloat(_p1.blue) / 255;
	var y = _elm_lang$core$Basics$toFloat(_p1.yellow) / 255;
	var r = _elm_lang$core$Basics$toFloat(_p1.red) / 255;
	return {
		red: _elm_lang$core$Basics$floor(((((((-34.935 * b) * r) * y) + ((85.935 * b) * r)) - ((41.565 * b) * y)) - (213.435 * b)) + 255.0),
		green: _elm_lang$core$Basics$floor(((((((((-176.715 * b) * r) * y) + ((159.885 * b) * r)) + ((73.185 * b) * y)) - (159.885 * b)) + ((127.5 * r) * y)) - (255.0 * r)) + 255.0),
		blue: _elm_lang$core$Basics$floor((((((((((-280.5 * b) * r) * y) + ((229.5 * b) * r)) + ((153.0 * b) * y)) - (102.0 * b)) + ((255.0 * r) * y)) - (255.0 * r)) - (255.0 * y)) + 255.0),
		alpha: _p1.alpha
	};
};
var _user$project$Day2_Ryb$Ryba = F4(
	function (a, b, c, d) {
		return {red: a, yellow: b, blue: c, alpha: d};
	});
var _user$project$Day2_Ryb$rgbaAsRyba = function (_p2) {
	var _p3 = _p2;
	return A4(_user$project$Day2_Ryb$Ryba, _p3.red, _p3.green, _p3.blue, _p3.alpha);
};
var _user$project$Day2_Ryb$ryb = F3(
	function (h, s, l) {
		return function (_p4) {
			var _p5 = _p4;
			return A4(_elm_lang$core$Color$rgba, _p5.red, _p5.green, _p5.blue, _p5.alpha);
		}(
			_user$project$Day2_Ryb$toRgba(
				_user$project$Day2_Ryb$rgbaAsRyba(
					_elm_lang$core$Color$toRgb(
						A3(
							_elm_lang$core$Color$hsl,
							_elm_lang$core$Basics$degrees(h),
							s,
							l)))));
	});
var _user$project$Day2_Ryb$ryba = F4(
	function (h, s, l, alpha) {
		return function (c) {
			return A4(_elm_lang$core$Color$rgba, c.red, c.green, c.blue, alpha);
		}(
			_elm_lang$core$Color$toRgb(
				A3(_user$project$Day2_Ryb$ryb, h, s, l)));
	});
var _user$project$Day2_Ryb$Rgba = F4(
	function (a, b, c, d) {
...
var _user$project$Helper$link = function (day) {
	var _p0 = A2(_elm_lang$core$Array$get, day - 1, _user$project$Helper$titles);
	if (_p0.ctor === 'Nothing') {
		return A2(
		...
		return A2(
			_elm_lang$html$Html$a,
			{
				...
				_0: _elm_lang$html$Html_Attributes$href(
					A2(
						_elm_lang$core$Basics_ops['++'],
						'http://fishgold.co/codecember16/Day',
...
var _user$project$Helper$title = function (day) {
	var _p1 = A2(_elm_lang$core$Array$get, day - 1, _user$project$Helper$titles);
	if (_p1.ctor === 'Nothing') {
		return _elm_lang$core$Native_Utils.crashCase(
			'Helper',
			{
				start: {line: 11, column: 5},
				end: {line: 16, column: 105}
			},
			_p1)('No day like the present');
	} else {
		return A2(
			_elm_lang$html$Html$h1,
			{
				...
				_0: _elm_lang$html$Html_Attributes$style(
					{
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'padding', _1: '5px 30px'},
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			},
...
var _user$project$Helper$project = F4(
	function (day, description, proj, model) {
		var header = A2(
			...
			{
				ctor: '::',
				_0: _user$project$Helper$link(day - 1),
				_1: {
					ctor: '::',
					_0: _user$project$Helper$title(day),
					_1: {
						ctor: '::',
						_0: _user$project$Helper$link(day + 1),
						_1: {ctor: '[]'}
						...
						_0: A2(
							_elm_lang$html$Html$div,
							{
								...
								_0: _elm_lang$html$Html_Attributes$style(
									{
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 'padding', _1: '50px 0'},
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							},
...
var _user$project$Loops$view = F2(
	function (res, model) {
		var command = F2(
			function (cmd, _p0) {
				var _p1 = _p0;
				return A2(
					...
					A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							_elm_lang$core$Basics$toString(
								_elm_lang$core$Basics$toFloat(_p1._0) * res),
							A2(
								_elm_lang$core$Basics_ops['++'],
								' ',
								_elm_lang$core$Basics$toString(
									_elm_lang$core$Basics$toFloat(_p1._1) * res)))));
			});
		var pathD = function (_p2) {
			var _p3 = _p2;
			return A2(
				_elm_lang$core$String$join,
				' ',
		...
		var loopPath = function (loop) {
			return A2(
				_elm_lang$svg$Svg$path,
				{
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$fill(
						_eskimoblood$elm_color_extra$Color_Convert$colorToCssRgba(loop.color)),
					_1: {
						ctor: '::',
		...
		var ht = _elm_lang$core$Basics$toFloat(model.height) * res;
		var wd = _elm_lang$core$Basics$toFloat(model.width) * res;
		return A2(
			...
			A2(_elm_lang$core$List$map, loopPath, model.loops));
	});
var _user$project$Loops$parseLoop = function (_p4) {
	var _p5 = _p4;
	return {
		deltas: _p5._0,
		center: _p5._1,
...
var _user$project$Loops$requestLoops = _elm_lang$core$Native_Platform.outgoingPort(
	'requestLoops',
	function (v) {
		return [v._0, v._1, v._2, v._3, v._4];
	});
var _user$project$Loops$init = F5(
	function (width, height, minLength, maxLength, count) {
		return {
			ctor: '_Tuple2',
			_0: {
				loops: {ctor: '[]'},
			...
			_1: _user$project$Loops$requestLoops(
				{ctor: '_Tuple5', _0: width, _1: height, _2: minLength, _3: maxLength, _4: count})
		};
	});
var _user$project$Loops$update = F2(
	function (msg, model) {
		var _p6 = msg;
		if (_p6.ctor === 'SetLoops') {
			return {
				ctor: '_Tuple2',
					...
					_1: _user$project$Loops$requestLoops(
						{
							...
							_2: model.minLength,
							_3: model.maxLength,
							_4: _elm_lang$core$List$length(model.loops)
						})
				};
			} else {
...
var _user$project$Loops$getLoops = _elm_lang$core$Native_Platform.incomingPort(
	'getLoops',
			...
			A2(
				...
				_elm_lang$core$Json_Decode$list(
					A2(
						...
						A2(_elm_lang$core$Json_Decode$index, 0, _elm_lang$core$Json_Decode$int)))))));
var _user$project$Loops$Model = F5(
	function (a, b, c, d, e) {
		return {loops: a, minLength: b, maxLength: c, width: d, height: e};
	});
var _user$project$Loops$Loop = F3(
	function (a, b, c) {
		return {deltas: a, center: b, color: c};
	});
var _user$project$Loops$Key = function (a) {
	return {ctor: 'Key', _0: a};
};
var _user$project$Loops$SetLoops = function (a) {
	return {ctor: 'SetLoops', _0: a};
};
var _user$project$Loops$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _user$project$Loops$getLoops(
				function (_p7) {
					return _user$project$Loops$SetLoops(
						A2(_elm_lang$core$List$map, _user$project$Loops$parseLoop, _p7));
				}),
			_1: {
				ctor: '::',
				_0: _elm_lang$keyboard$Keyboard$ups(_user$project$Loops$Key),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Loops$main = _elm_lang$html$Html$program(
	{
...
var Elm = {};
Elm['Loops'] = Elm['Loops'] || {};
if (typeof _user$project$Loops$main !== 'undefined') {
    _user$project$Loops$main(Elm['Loops'], 'Loops', undefined);
}
