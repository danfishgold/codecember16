...
var _user$project$Poisson$circle = F3(
	function (c, rad, shift) {
		return A2(
			...
			A2(
				...
				c,
				_evancz$elm_graphics$Collage$circle(rad)));
	});
var _user$project$Poisson$view = function (model) {
	var radius = function (dt) {
		return A2(
			F2(
				function (x, y) {
					return x * y;
			...
			2,
			A2(_elm_lang$core$Basics$min, 1, dt / (0.2 * _elm_lang$core$Time$second)));
	};
	var point = function (_p0) {
		var _p1 = _p0;
		return A3(
			_user$project$Poisson$circle,
			_elm_lang$core$Color$black,
			radius(model.time - _p1._1),
			{ctor: '_Tuple2', _0: _p1._0._0 - (model.width / 2), _1: _p1._0._1 - (model.height / 2)});
	};
	var finals = A2(_elm_lang$core$List$map, point, model.finals);
	return _evancz$elm_graphics$Element$toHtml(
		A3(
			_evancz$elm_graphics$Collage$collage,
			_elm_lang$core$Basics$floor(model.width),
			_elm_lang$core$Basics$floor(model.height),
			finals));
};
var _user$project$Poisson$init = function (_p2) {
	var _p3 = _p2;
	return {
		ctor: '_Tuple2',
		_0: {
			candidates: _elm_lang$core$Set$empty,
			finals: {ctor: '[]'},
			width: _p3.width,
			height: _p3.height,
			finished: false,
...
var _user$project$Poisson$checkRandomCandidate = _elm_lang$core$Native_Platform.outgoingPort(
	'checkRandomCandidate',
	function (v) {
		return null;
	});
var _user$project$Poisson$update = F2(
	function (msg, model) {
		var _p4 = msg;
		switch (_p4.ctor) {
			case 'Tick':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{time: _p4._0}),
					_1: _user$project$Poisson$checkRandomCandidate(
						{ctor: '_Tuple0'})
				};
			case 'MoveToFinal':
				var _p5 = _p4._0;
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							candidates: A2(_elm_lang$core$Set$remove, _p5, model.candidates),
							finals: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: _p5, _1: model.time},
								_1: model.finals
							}
						}),
					_1: _elm_lang$core$Platform_Cmd$none
...
var _user$project$Poisson$candidates = _elm_lang$core$Native_Platform.incomingPort(
	'candidates',
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (x0) {
...
var _user$project$Poisson$finals = _elm_lang$core$Native_Platform.incomingPort(
	'finals',
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (x0) {
		...
		A2(_elm_lang$core$Json_Decode$index, 0, _elm_lang$core$Json_Decode$float)));
var _user$project$Poisson$finished = _elm_lang$core$Native_Platform.incomingPort(
	'finished',
	_elm_lang$core$Json_Decode$null(
		{ctor: '_Tuple0'}));
var _user$project$Poisson$Flags = F4(
	function (a, b, c, d) {
		return {width: a, height: b, r: c, k: d};
	});
var _user$project$Poisson$Model = F6(
	function (a, b, c, d, e, f) {
		return {candidates: a, finals: b, width: c, height: d, finished: e, time: f};
	});
var _user$project$Poisson$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _user$project$Poisson$Finished = {ctor: 'Finished'};
var _user$project$Poisson$MoveToFinal = function (a) {
	return {ctor: 'MoveToFinal', _0: a};
};
var _user$project$Poisson$AddCandidate = function (a) {
	return {ctor: 'AddCandidate', _0: a};
};
var _user$project$Poisson$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _user$project$Poisson$candidates(_user$project$Poisson$AddCandidate),
			_1: {
				ctor: '::',
				_0: _user$project$Poisson$finals(_user$project$Poisson$MoveToFinal),
				_1: {
					ctor: '::',
					_0: _user$project$Poisson$finished(
...
var _user$project$Poisson$main = _elm_lang$html$Html$programWithFlags(
	{
		init: _user$project$Poisson$init,
		subscriptions: _user$project$Poisson$subscriptions,
		update: _user$project$Poisson$update,
		view: A2(_user$project$Helper$project, 6, _user$project$Poisson$view)
	})(
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (height) {
					...
					return A2(
						...
						function (r) {
							return A2(
								...
								function (width) {
									return _elm_lang$core$Json_Decode$succeed(
										{height: height, k: k, r: r, width: width});
								},
								A2(_elm_lang$core$Json_Decode$field, 'width', _elm_lang$core$Json_Decode$float));
						},
						A2(_elm_lang$core$Json_Decode$field, 'r', _elm_lang$core$Json_Decode$float));
				},
				A2(_elm_lang$core$Json_Decode$field, 'k', _elm_lang$core$Json_Decode$int));
		},
		A2(_elm_lang$core$Json_Decode$field, 'height', _elm_lang$core$Json_Decode$float)));

var Elm = {};
Elm['Poisson'] = Elm['Poisson'] || {};
if (typeof _user$project$Poisson$main !== 'undefined') {
    _user$project$Poisson$main(Elm['Poisson'], 'Poisson', undefined);
}
