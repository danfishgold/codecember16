					...
					_1: {
						...
						_1: {
							...
							_0: _elm_lang$svg$Svg_Attributes$fill(
								_eskimoblood$elm_color_extra$Color_Convert$colorToCssRgb(c)),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _user$project$Poisson$view = function (model) {
	...
	var point = function (_p2) {
		var _p3 = _p2;
		var _p4 = _p3._0;
		return {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Basics$toString(_p4),
			_1: A3(
				_user$project$Poisson$circle,
				_elm_lang$core$Color$black,
				radius(model.time - _p3._1),
				_p4)
		};
	};
...
var _user$project$Poisson$init = function (_p5) {
	var _p6 = _p5;
	return {
		ctor: '_Tuple2',
		_0: {
			...
			case 'MoveToFinal':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							candidates: A2(_elm_lang$core$Set$remove, _p8, model.candidates),
							finals: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: _p8, _1: model.time},
								_1: model.finals
							}
						}),
					_1: _elm_lang$core$Platform_Cmd$none
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							candidates: A2(
								...
								{ctor: '_Tuple2', _0: _p7._0._0, _1: _p7._0._1},
								model.candidates)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
